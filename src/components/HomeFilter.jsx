...
const HomeFilter = () => {
    ...
    const accommodationOptions = [
        ...
        { value: 'Non-alcoholic all inclusive', label: 'Non-alcoholic all inclusive' }
    ...
    const handleSelectChange = (selectedOptions, action) => {
        dispatch(setFilters({ [action.name]: selectedOptions ? selectedOptions.map(option => option.value) : [] }));
    };
    ...
    const handleSubmit = () => {
        ...
        const queryString = new URLSearchParams({
            ...
            price: filters.minPrice && filters.maxPrice ? filters.minPrice + "-" + filters.maxPrice : "0-99999999",
            accomudationType: filters.accommodationType.join(','),
            //TODO
            hotelType: filters.hotelType ? filters.hotelType.join(','): "",
            roomAmenities: Array.isArray(filters.amenities) ? filters.amenities.join(',') : ''
        }).toString();
        ...
        <div className="filter-container">
            ...
            <div className="filter-row">
                ...
                <Select
                    ...
                    onChange={(selectedOptions) => handleSelectChange(selectedOptions, { name: 'accommodationType' })}
                ...
                <Select
                    ...
                    options={hotelType}
                    isMulti
                    value={filters.hotelType ? hotelType.filter(option => filters.hotelType.includes(option.value)) : []}
                    onChange={(selectedOptions) => handleSelectChange(selectedOptions, { name: 'hotelType' })}
                ...
                <Select
                    ...
                    onChange={(selectedOptions) => handleSelectChange(selectedOptions, { name: 'amenities' })}
